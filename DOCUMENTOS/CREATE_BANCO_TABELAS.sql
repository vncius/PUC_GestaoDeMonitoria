...
-- Copiando dados para a tabela sysmonitoria.incricao_monitoria: ~4 rows (aproximadamente)
...
REPLACE INTO `usuario` (`id`, `matricula`, `nome`, `senha`, `fk_curso_id`, `fk_role_id`) VALUES
	...
	(6, 'cord_caeme', 'Oliveira Alves', '$2a$10$PbeSDMyjcB7rENa1Hepuy.ZFGtkkCUAxQmsx7sno2Wm8deSN0aaF.', 0, 4),
	(7, 'cord_curso', 'Fernando Souza', '$2a$10$PbeSDMyjcB7rENa1Hepuy.ZFGtkkCUAxQmsx7sno2Wm8deSN0aaF.', 0, 5),
	(8, 'cord_monitoria', 'Luiza Mota', '$2a$10$PbeSDMyjcB7rENa1Hepuy.ZFGtkkCUAxQmsx7sno2Wm8deSN0aaF.', 0, 6),
